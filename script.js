//Pages
const Logo = document.querySelectorAll('.logo').forEach(logo =>{
...
//Login
const Login = document.querySelectorAll('.login').forEach(loginBtn =>{
...
//SignUpo
const SignUp = document.querySelectorAll('.signup').forEach(signup =>{
